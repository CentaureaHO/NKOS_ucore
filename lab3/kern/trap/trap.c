...
static int pgfault_handler(struct trapframe* tf)
{
    ...
    print_pgfault(tf);
    if (check_mm_struct != NULL) { return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr); }
...
void exception_handler(struct trapframe* tf)
{
    ...
    switch (tf->cause)
    {
        ...
        case CAUSE_LOAD_ACCESS:
            ...
            break;
        case CAUSE_MISALIGNED_STORE: cprintf("AMO address misaligned\n"); break;
        case CAUSE_STORE_ACCESS:
            ...
            break;
        case CAUSE_USER_ECALL: cprintf("Environment call from U-mode\n"); break;
        case CAUSE_SUPERVISOR_ECALL: cprintf("Environment call from S-mode\n"); break;
